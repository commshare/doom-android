...
class Globals {
	...
	public static String fileExistFlag = "data_copy_finish.flag";
	public static int VERSION = 0x41;
	// Should be zip file
	...
	public static boolean AppUsesMouse = true;//edited by niuzb
	...
	public static boolean UseTouchscreenKeyboard = false;//edited by niuzb
